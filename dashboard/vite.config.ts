...
export default defineConfig({
  ...
  resolve: {
    alias: {
      "@understand-anything/core/schema": path.resolve(__dirname, "../agentcore/packages/core/dist/schema.js"),
      "@understand-anything/core/search": path.resolve(__dirname, "../agentcore/packages/core/dist/search.js"),
      "@understand-anything/core/types": path.resolve(__dirname, "../agentcore/packages/core/dist/types.js"),
    },
  },
